...
{
    [NoCache]
    public class BaseVendorController : Controller
    {
        ...
        public BaseVendorController(IErrorLogManager errorLogManager)
        {
        ...
        protected override void OnAuthorization(AuthorizationContext filter_context)
        {
            ...
            HttpCookie auth_cookie = Request.Cookies[Cookies.VendorAuthorizationCookie];
            HttpCookie admin_auth_cookie = Request.Cookies[Cookies.VendorAuthorizationCookie];
            ...
            {
                HttpCookie val = Request.Cookies[Cookies.VendorAuthorizationCookie];
                val.Expires = DateTime.Now.AddDays(-30);
                Response.Cookies.Add(val);
                filter_context.Result = RedirectToAction("Index", "Home", new { Area = "Vendor" });
            }
        ...
        protected virtual void CreateAgentAuthorisationCookie(String user_name, Boolean is_persistent, String custom_data)
        {
            ...
            HttpCookie auth_cookie_ud = new HttpCookie(Cookies.VendorAuthorizationCookie, encrypted_ticket_ud);
        ...
        {
            var cookie = Request.Cookies[Cookies.VendorAuthorizationCookie];
            ...
            cookie = new HttpCookie(Cookies.VendorAuthorizationCookie, encryptedTicket);
