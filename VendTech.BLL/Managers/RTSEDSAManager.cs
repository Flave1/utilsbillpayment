...
namespace VendTech.BLL.Managers
{
    public class RTSEDSAManager : BaseManager, IRTSEDSAManager
    {
        ...
        async Task<PagingResult<RtsedsaTransaction>> IRTSEDSAManager.GetTransactionsAsync(TransactionRequest model)
        {
            ...
            requestObj.Header = new Models.Header
            {
                System = "SL",
        ...
        private static async Task<string> SendHttpRequestAsync(string requestUrl, HttpMethod httpMethod, string requestBody = null)
        {
            try
            {
